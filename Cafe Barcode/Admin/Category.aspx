<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="Cafe_Barcode.Admin.Category" %>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:LinkButton ID="lnkEdit" Text="Edit" runat="server" CssClass="badge badge-primary"
                                                        CommandArguement='<%#Eval("CategoryId") %>' CommandName="edit">
                                                        <asp:HiddenField ID="hiddenProductId" Value='<%#Eval("CategoryId")%>' runat="server" />
                                                        <i class="ti-pencil"></i>
                                                    </asp:LinkButton>

                                                    <asp:LinkButton ID="lnkDelete" Text="Delete" runat="server" CssClass="badge bg-danger"
                                                        CommandArguement='<%#Eval("CategoryId") %>' CommandName="delete" OnClientClick="return confirm('Do you want to delete this category?');">
                                                        <asp:HiddenField ID="HiddenField2" runat="server" Value='<%#Eval("CategoryId")%>'/>
                                                        <i class="ti-trash"></i>
                                                    </asp:LinkButton>
                                                </td>
                                            </tr>
